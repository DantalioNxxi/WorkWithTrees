...
/**
 * Class of the Binary Search Tree.
 * This class inherit the class BinaryTree.
 * He contains the class of the node for a binary search tree.
 * @author DantalioNxxi
 * @version 1.4
 * @since 1.0
 * @see BinaryTree
...
//        /**Value ot the node.*/
        ...
        public boolean containChild(int kc) {
            ...
            if (this.right != null && this.right.key == kc) {
                return true;
            }
            return false;
        }
     ...
     * @see BinarySearchTree#rotationToLeft(int) 
     * @see BinarySearchTree#rotationToRight(int) 
     */
    private boolean isLeftSubNode(int key) {
     ...
     * @see BinarySearchTree#rotationToRight(int)
     */
    private boolean isRightSubNode(int key) {
     ...
     * @see BinarySearchTree#addChild(int, int, int) 
     */
    private boolean isAllowedInsert (int keyParent, int keyChild) {
        ...
        //The second check for satisfying the rule of a binary search tree
     ...
     * @see BinarySearchTree#isAllowedInsert(int, int) 
     * @see BinarySearchTree#getNode(int) 
     */
//    @Override
    ...
    /**
    * Adds a new root for this Binary Search Tree.
    * Uses the methods add, containsKey and insertRoot.
    * @param newKey key of new root
    * @param newValue value of new root
    * @see BinarySearchTree#add(int, int) 
    * @see BinarySearchTree#containsKey(int) 
    * @see BinarySearchTree#insertRoot(workwithtrees.BinarySearchTree.Node, int, int) 
    */
//    @Override
    public void addNewRoot(int newKey, int newValue){
        if (root == null){//If the Binary Search Tree is empty
            add(newKey, newValue);
            return;
        }
     ...
     * @see BinarySearchTree#addNewRoot(int, int) 
     * @see BinarySearchTree#rotationToLeft(int) 
     * @see BinarySearchTree#rotationToRight(int) 
     */
...
//        Node temp=p;
    ...
    /**
     * A method-wrapper for the calculting of the depth
     * for a root node of this Binary Search Tree.
     * Uses a methid depth(Node p)
     * @return a depth for this Binary Tree
     * @see BinarySearchTree#depth(workwithtrees.BinarySearchTree.Node) 
     */
    @Override
    public int depth() {
        return depth(root);
     ...
     * @see BinarySearchTree#fillPir(workwithtrees.BinarySearchTree.Node, int, java.util.ArrayList, boolean) 
     */
     ...
     * @see BinarySearchTree#fillPir(workwithtrees.BinarySearchTree.Node, int, java.util.ArrayList, boolean) 
     * @see BinarySearchTree#indention(boolean, int, workwithtrees.BinaryTree.Indent) 
     */
     ...
     * and printTree().
     * @see BinarySearchTree#fillPir(workwithtrees.BinarySearchTree.Node, int, java.util.ArrayList, boolean) 
     * @see BinarySearchTree#printLevels(java.util.ArrayList) 
     * @see BinarySearchTree#printCompressPyr(java.util.ArrayList, boolean) 
     ...
     * @see BinarySearchTree#fillPirOnlyKeys(workwithtrees.BinarySearchTree.Node, int, java.util.ArrayList) 
     */
